...
const ServicesPreview = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-gray-300/10 animate-pulse-glow" />
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {SERVICES.slice(0, 6).map((service, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-textPrimary group-hover:text-white transition-colors">
                {service.title}
              </h3>
            </motion.div>
          ))}
